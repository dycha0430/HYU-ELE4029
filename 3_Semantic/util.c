  ...
  while (tree != NULL) {
    ...
    switch (tree->kind) {
        ...
        case OpK:
            ...
            break;
        case VarDecK:
            if (tree->type == Void) type = "void";
            else if (tree->type == Integer) type = "int";
            else if (tree->type == IntegerArray) type = "int[]";
        ...
        case TypeK:
            if (tree->type == Void) {
                if (tree->isArray) type = "void[]";
                else type = "void";
            }   
            else if (tree->type == Integer) {
                if (tree->isArray) type = "int[]";
                else type = "int"; 
            } 
        ...
        case ParamK:
            ...
            if (tree->attr.name == NULL && tree->type == Void) fprintf(listing, "Void Parameter\n");
            else fprintf(listing, "Parameter: name = %s, type = %s\n", tree->attr.name, type);
            break;
        case CompK:
